    ...
    render() {
        ...
        if(imagePreviewUrl){
            $imagePreview=(
                ...
                <a href={imagePreviewUrl} data-size="1600x1067">
                    <img src={imagePreviewUrl} data-size="1600x1067" style={{width:'300px', height:'300px'}} className=" w-75 mx-auto mt-5 mb-2 py-3  waves-effect waves-light info-color white-text"/>
                    </a> 
                );
        }
        else{
            $imagePreview=(<a href="default_1.png" data-size="1600x1067">
            <img src="/default_1.png"  data-size="1600x1067" style={{width:'300px', height:'300px'}} className=" w-75 mx-auto mt-5 mb-2 py-3  waves-effect waves-light info-color white-text"/>
            </a>)
        }
        return (
            <div >
            <div  >
                ...
                <br/><br/><br/><br/> <br/>
                <div style={{ marginTop: 10 }} className="container mx-auto  py-3" style={{ border: '1px solid #4285f4', borderRadius: '40px', width: '70%' }} >
                    ...
                    <br/>
                      ...
                      <form >  
                        <input style={{ borderRadius: '10px' }} type="file" accept="image/* "  id="file" className="mt-4 btn-lg py-2 px-3 btn btn-outline-info waves-effect font-weight-bold"  onChange={(e)=>this._handleImagechange(e)}/>
                        <br />
