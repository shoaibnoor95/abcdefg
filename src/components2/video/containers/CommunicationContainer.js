...
import {changeAudio} from '../../../store/action/apiAction';
import {changeVideo} from '../../../store/action/apiAction';
class CommunicationContainer extends React.Component {
  ...
  componentDidMount() {
    ...
    this.setState({video: this.props.video, audio: this.props.audio,room:this.props.room});
    socket.on('create', () =>
...
const mapDispatchToProps = dispatch => (
  {
    setVideo: boo => dispatch(changeVideo(boo)),
    setAudio: boo => dispatch(changeAudio(boo))
  }
);
