...
const Communication = props =>
  <div className="auth">
    <div className="media-controls">
      ...
      <button onClick={props.toggleAudio} className={'audio-button-' + props.audio+"  buttona"}>
      ...
      <button onClick={props.toggleVideo} className={'video-button-' + props.video+"  buttona"}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
      ...
      <button onClick={ToggleFullScreen} className="fullscreen-button buttona">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
      ...
      <button onClick={props.handleHangup} className="hangup-button  buttona" >
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 50 50" className="svg">
    ...
    <div className="request-access">
      ...
      <form onSubmit={props.send}>
        <input  type="text" autoFocus onChange={props.handleInput} data-ref="message"  maxLength="30" required placeholder="Invite the other person." className="inputa" />
        <button className="primary-button  buttona">Send</button>
      </form>
    </div>
